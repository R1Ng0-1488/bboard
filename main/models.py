...
class SuperRubricManger(models.Manager):
    def get_queryset(self):
        return super().get_queryset().filter(super_rubric__isnull=True)


class SuperRubric(Rubric):
    objects = SuperRubricManger()
...
class Bb(models.Model):
    rubric = models.ForeignKey(SubRubric, on_delete=models.PROTECT, verbose_name='Руьрика')
    ...
    is_active = models.BooleanField(default=True, db_index=True, verbose_name='Выводить в список?')
...
class AdditionalImage(models.Model):
    ...
    image = models.ImageField(upload_to='media', verbose_name='Изображения')
